// Debug version of component registry
class ComponentRegistry {
    static async loadComponent(componentName) {
        ...
        try {
            ...
            console.log(`Loaded component ${componentName} successfully`);
            return text;
        } catch (error) {
    ...
    static async registerComponents() {
        ...
        console.log("Nav placeholder:", navPlaceholder);
        if (navPlaceholder) {
    ...
    static initNavActiveState() {
        console.log("Initializing nav active state...");
...
function typeExpertise() {
    console.log("Initializing expertise typing...");
...
function typeLifestyle() {
    console.log("Initializing lifestyle typing...");
...
document.addEventListener('DOMContentLoaded', () => {
    console.log("DOM loaded, registering components...");
